...
public class MonsterRunner
{
    ...
    if (monsterOne.isBigger(monsterTwo)) System.out.println("Monster one is bigger than Monster two");
    else System.out.println("Monster one is smaller than Monster two");

    if (monsterOne.namesTheSame(monsterTwo)) System.out.println("Monster one has the same name as Monster two");
